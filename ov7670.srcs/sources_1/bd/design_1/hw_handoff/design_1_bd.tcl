...
proc create_root_design { parentCell } {
  ...
  set cntl_in2 [ create_bd_port -dir I cntl_in2 ]
  set din [ create_bd_port -dir I -from 7 -to 0 din ]
  set last_add [ create_bd_port -dir O -from 17 -to 0 -type data last_add ]
...
CONFIG.CLKOUT4_JITTER {157.650} \
CONFIG.CLKOUT4_PHASE_ERROR {87.466} \
...
CONFIG.CLK_OUT4_PORT {test_24MHz} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net camera_capture_0_last_addr [get_bd_ports last_add] [get_bd_pins camera_capture_0/last_addr]
